...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('invoices/update') }}" enctype="multipart/form-data" autocomplete="off"
                        method="post">
                        @method('PUT')
                        @csrf
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="hidden" name="invoices_id" value="{{ $invoices->id }}">
                            </div>

                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    value="{{ $invoices->invoices_date }}" type="text" value="{{ date('Y-m-d') }}"
                                    required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="{{ $invoices->section->id }}" selected disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value="{{ $invoices->amount_comission }}" required>
                            </div>
