...
<!-- Internal Data table css -->
 <link href="{{ URL::asset('assets/plugins/datatable/css/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
     <ink href="{{ URL::asset('assets/plugins/datatable/css/buttons.bootstrap4min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/plugins/datatable/css/responsive.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ URL::asset('assets/plugins/datatable/css/jquery.dataTables.min.css') }}" rel="stylesheet">
     <ink href="{{ URL::asset('assets/plugins/datatable/css/responsive.datTables.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/plugins/select2/css/select2.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets/plugins/prism/prism.css') }}" rel="stylesheet">
     <---Internal Owl Carousel css-->
    <link href="{{ URL::asset('assets/plugins/owl-carousel/owl.carousel.css') }}" rel="stylesheet">
    <!---Internal  Multislider css-->
     <ink href="{{ URL::asset('assets/plugins/multislider/multslider.css') }}" rel="stylesheet">
    <!--- Select2 css -->
    <link href="{{ URL::asset('assets/plugins/select2/css/select2.min.css') }}" rel="stylesheet">
@endsection
@section('page-header')
                            ...
                            @foreach ($products as $p)
                                ...
                                <tr>
                                    ...
                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    ...
                                                    data-section_name="{{ $p->section->section_name }}"
                                                    data-description="{{ $p->description }}" data-toggle="modal"
                                                    href="#edit_Product" title="تعديل"><i class="las la-pen"></i>
                                    </a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="products/destroy" method="post">
                    ...
                    @csrf
                    <div class="modal-body">
                        <p>هل انت متاكد من حدف هذا المنتج؟</p><br>
