                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                        data-id="{{ $s->id }}"
                                                        data-section_name="{{ $s->section_name }}"
...
@section('js')
    ...
    <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var action = '{{ route('sections.update', ':id') }}';
            action = action.replace(':id', id); // Replace :id with the actual ID
